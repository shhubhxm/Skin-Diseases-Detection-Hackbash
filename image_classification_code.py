...
# image_path = "Data"
image_path = "Data1H(with-noise)"#Directory of the data
...
#SINGLE MODEL
model = image_classifier.create(train_data,dropout_rate=0.5,epochs = 10)

#Evaluating model
loss, accuracy = model.evaluate(test_data)

# #Export TFLite file
model.export(export_dir='model(with-noise)')

# #Export LABEL file
model.export(export_dir='model(with-noise)', export_format=ExportFormat.LABEL)
